...
@Composable
fun WinnerPage(navController: NavController) {
...
//navController.navigate(Screen.WinnerPage.route + "/Yellow/" + playerName.replace("/", " "))

@Preview
@Composable
fun preView() {
    WinnerPage(navController = rememberNavController())
}
